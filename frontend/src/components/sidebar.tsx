...
export function Sidebar() {
  ...
  const regions = [
    ...
    {
      name: 'Holanda',
      desc: 'Campos de tulipas e clima temperado',
      coordinates: '52°N, 5°E',
      stats: {
        flowerDensity: 95,
        beeActivity: 82,
        bloomIntensity: 98,
      ...
      trends: {
        flowers: '+25% este mês',
        bees: '+15% esta semana',
        risk: 'Risco moderado de chuva',
      },
      dominantSpecies: {
        flowers: ['Tulipa', 'Jacinto', 'Narciso'],
        bees: ['Apis mellifera', 'Bombus terrestris'],
      },
      alerts: ['Pico de floração atual', 'Monitorar previsão de chuva'],
    },
    {
      name: 'Califórnia',
